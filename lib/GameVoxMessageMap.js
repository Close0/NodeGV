...
var xmlMessageStructure = {
	...
	'MTYPE_CONN_serverConnect': {
		serverId: 'gvid',
		password: 'string',
	},
	'MTYPE_CONN_serverDisconnect': {
		serverId: 'gvid'
	},
	//Server -> Client
	...
	'MTYPE_CONNECT_AUTHENTICATED': {
		sessionId: 'gvid',
		success: 'boolean',
		uid: 'gvid',
		username: 'string',
	},
	'MTYPE_CONN_serverUsageUpdate': {
		SID: 'gvid',
		sessionCount: 'i4',
	},
	'MTYPE_CONN_connectedToVS': {
		serverId: 'gvid',
		zuid: 'string',
		serverDataCenter: 'string',
		serverName: 'string',
	},
	'MTYPE_CONN_disconnectedFromVS': {
		serverId: 'gvid',
		reason: 'string'
	}
};
var xmlMap = {
	...
	0x7106: 'MTYPE_CONNECTION_ACTIVATED',
	...
	0x7704: 'MTYPE_CONN_connectedToVS',
	0x7705: 'MTYPE_CONN_favoriteServers',
	0x7709: 'MTYPE_CONN_friends',
	0x770a: 'MTYPE_CONN_friendUpdate',
	0x7718: 'MTYPE_CONN_serverUsageUpdate',
	0x7719: 'MTYPE_CONN_disconnectedFromVS',

	0x770f: 'MTYPE_CONN_serverConnect',
	0x7710: 'MTYPE_CONN_serverDisconnect',
};
