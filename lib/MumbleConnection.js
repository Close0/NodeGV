...
MumbleConnection.prototype.generateSound = function() {
	...
	setInterval(function() {
		...
		var voiceData = new Buffer(6);
		voiceData.writeInt8(0x01, 0); //TODO: Defined in Message.h::MessageHandler::UDPMessageType::UDPVoiceOpus
		//voiceData.writeInt32BE(self.sessionId, 1);
		voiceData.writeInt32BE(++sequenceNumber, 1); //Sequence
		voiceData.writeInt8(0x01, 5); //Audio header, Bit 1: Terminator, Bit 2-8: Data length
		//voiceData.writeInt8(0x42, 6);
		...
		//this.sendMessage('UDPTunnel', {
		//	packet: [0x00,0x00,0x00,0x00]
		//});

	//console.log(this.sessionId);
	//while(1) {
	//	var voiceData = new Buffer(10);
	//	voiceData.writeUInt16BE(0x00, 0);
	//	voiceData.writeUInt32BE(this.sessionId, 2);
	//	voiceData.writeUInt16BE(0x81, 6);
	//	voiceData.writeUInt16BE(0x01, 8);
//
	//	var prefix = new Buffer(6);
	//	prefix.writeUInt16BE(0x00, 0);
	//	prefix.writeUInt32BE(voiceData.length, 2);
//
	//	this.socket.write(prefix);
	//	this.socket.write(voiceData);
	//}


	//this.socket.write(new Buffer([0x01]));
	//this.socket.write(new Buffer([voiceData.length]));
	//this.socket.write(voiceData);
