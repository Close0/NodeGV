...
MumbleConnection.prototype.generateSound = function() {
	...
	setInterval(function() {
		...
		voiceData.writeInt16BE(0x00, 0);
		voiceData.writeInt32BE(self.sessionId, 2);
		voiceData.writeInt16BE(0x81, 6);
		voiceData.writeInt16BE(0x01, 8);

		var prefix = new Buffer(6);
		prefix.writeInt16BE(0x00, 0);
		prefix.writeInt32BE(voiceData.length, 2);

		self.socket.write(prefix);
		console.log("SessionID: " + self.sessionId);
		self.socket.write(voiceData);
	},100);
