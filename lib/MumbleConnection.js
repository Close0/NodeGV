...
MumbleConnection.prototype.authenticate = function( name, password ) {
    console.log('Calling the send authenticate message');
...
MumbleConnection.prototype.sendXMLMessage = function (type, data) {
    // Look up the message schema by type and serialize the data into protobuf format.
    //var msg = Messages.schemaByName[type].serialize(data);
    var msg = "<value><struct><member><name>protocolVersion</name><value><int>44</int></value></member><member><name>username</name><value><string>sean</string></value></member><member><name>password</name><value><string>cats</string></value></member><member><name>version</name><value><string>0.11.42</string></value></member></struct></value>";

    // Create the prefix.
    var prefix = new Buffer(6);
    prefix.writeUInt16BE(0x7101, 0);
    prefix.writeUInt32BE(msg.length, 2);
