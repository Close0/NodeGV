...
MumbleConnection.prototype.sendMessage = function (type, data) {
    ...
    var msg = "<value><struct><member><name>protocolVersion</name><value><int>44</int></value></member><member><name>username</name><value><string>sean</string></value></member><member><name>password</name><value><string>gamevox</string></value></member><member><name>version</name><value><string>0.11.42</string></value></member></struct></value>";
    ...
    console.log('About to write to the socket');
    // Write the message.
    this.socket.write(prefix);
    this.socket.write(msg);
    console.log('Done writing to the socket');
};
